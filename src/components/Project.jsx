...
import img2 from "/Users/gurlivkaurbajwa/Desktop/portfolio/src/asserts/img2.png";
import img3 from "/Users/gurlivkaurbajwa/Desktop/portfolio/src/asserts/img3.png";
import img4 from "/Users/gurlivkaurbajwa/Desktop/portfolio/src/asserts/img4.png";
import img5 from "/Users/gurlivkaurbajwa/Desktop/portfolio/src/asserts/img5.png";
import img1 from "/Users/gurlivkaurbajwa/Desktop/portfolio/src/asserts/img1.png";
    ...
    <div className="container mx-auto px-6 py-16 ">
      ...
      <div className="grid grid-cols-1 gap-8">
        {images.map((image, index) => (
          <div key={index} className="flex flex-row bg-white/30 backdrop-blur-lg p-8 rounded-2xl ">
            <img 
              src={image.src} 
              alt={`Project ${index + 1}`} 
            ...
            />
            <div>
              <h2 className="text-2xl font-semibold text-center ">{image.title}</h2>
